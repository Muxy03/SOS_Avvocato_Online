import { u as push, y as escape_html, w as pop, G as ensure_array_like, J as attr_class } from './index-CJFxRk-N.js';
...
function Carousel($$payload, $$props) {
  ...
  $$payload.out.push(`<!--]--> <p>${escape_html(currentIndex + 1)}/${escape_html(data.length)}</p></div>`);
  pop();
}
...
//# sourceMappingURL=_page.svelte-X9fr3rl-.js.map
