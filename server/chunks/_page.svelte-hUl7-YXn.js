import { X as escape_html, Z as attr, a1 as stringify } from './index-BaZFIA8u.js';

function _page($$payload, $$props) {
  let { data } = $$props;
  const { consultations, error } = data;
  let current = 0;
  $$payload.out.push(`<div class="flex w-full flex-col items-center justify-between gap-3">`);
...
//# sourceMappingURL=_page.svelte-hUl7-YXn.js.map
